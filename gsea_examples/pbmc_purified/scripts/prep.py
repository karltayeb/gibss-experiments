...
Outputs (the design-cache contract consumed by fit_cell.py, identical to lifan's):
...
def prep_unit(unit_tsv, collection, *, min_set_size, max_set_size):
    df = (
...
if "snakemake" in globals():
    ...
    save_prep(
        prep_unit(
            smk.input.unit_tsv, p.collection,
